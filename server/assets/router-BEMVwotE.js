...
const appCss = "/assets/styles-BTneYC-K.css";
...
const Route$4 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Train your phishing detection skills with CyberGuard." },
      { name: "author", content: "CyberGuard" },
      { property: "og:title", content: "CyberGuard — Cybersecurity Awareness Game" },
      { property: "og:description", content: "Train your phishing detection skills with CyberGuard." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "CyberGuard — Cybersecurity Awareness Game" },
      { name: "twitter:description", content: "Train your phishing detection skills with CyberGuard." }
    ],
    links: [
      {
        rel: "stylesheet",
...
const $$splitComponentImporter$3 = () => import("./profile-BFuDAeNU.js");
const Route$3 = createFileRoute("/profile")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Your CyberGuard agent profile, badges, and settings."
    }]
  })
});
const $$splitComponentImporter$2 = () => import("./play-CrJT-xFF.js");
const Route$2 = createFileRoute("/play")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Test your phishing detection skills in CyberGuard."
    }]
  })
});
const $$splitComponentImporter$1 = () => import("./leaderboard-nQCg44op.js");
const Route$1 = createFileRoute("/leaderboard")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Top CyberGuard agents ranked by score."
    }]
  })
});
const $$splitComponentImporter = () => import("./index-DEE8xGPh.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Train your phishing detection skills with CyberGuard, the cybersecurity awareness game."
    }]
  })
});
