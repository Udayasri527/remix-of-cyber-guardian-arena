...
import { c as createLucideIcon, u as useAuth, s as supabase, S as Shield, M as Mail, A as AuthForm, N as Navbar } from "./AuthForm-DKctwT-G.js";
...
function GamePlay() {
  ...
  const handleAction = reactExports.useCallback(
    (action) => {
      if (feedback) return;
      const scenario2 = scenarios[currentIndex];
      if (!scenario2) return;
      let correct = false;
      if (scenario2.is_phishing) {
        correct = action === "report";
      } else {
        correct = action === "open" || action === "ignore";
      }
      const points = correct ? scenario2.difficulty === "hard" ? 30 : scenario2.difficulty === "medium" ? 20 : 10 : 0;
      setScore((s) => s + points);
      if (correct) setCorrectCount((c) => c + 1);
      setFeedback({ correct, explanation: scenario2.explanation, action });
    },
    [feedback, scenarios, currentIndex]
  );
  const nextScenario = reactExports.useCallback(async () => {
    setFeedback(null);
    setExpanded(false);
    if (currentIndex + 1 >= scenarios.length) {
      ...
      if (user) {
        ...
        const { data: profile } = await supabase.from("profiles").select("total_score, games_played").eq("id", user.id).single();
        if (profile) {
  ...
  const checkBadges = async (totalScore, gamesPlayed, isPerfect) => {
    if (!user) return;
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-[60vh] items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-12 w-12 animate-pulse text-primary" }) });
  }
  if (gameOver) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-full border border-primary/30 bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "h-10 w-10 text-primary neon-text" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold tracking-wider text-foreground", children: "MISSION COMPLETE" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid grid-cols-3 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-surface p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-bold text-primary", children: score }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Score" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-surface p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display text-2xl font-bold text-neon-green", children: [
                correctCount,
                "/",
                scenarios.length
              ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-surface p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display text-2xl font-bold text-neon-yellow", children: [
                pct,
                "%"
              ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-2xl space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "rounded-full bg-primary/10 px-3 py-1 font-display text-xs font-bold text-primary", children: [
          currentIndex + 1,
          " / ",
          scenarios.length
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-bold uppercase ${difficultyColors[scenario.difficulty]}`, children: scenario.difficulty })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 rounded-full bg-surface px-4 py-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "h-4 w-4 text-neon-yellow" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-sm font-bold text-foreground", children: score })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "scan-overlay", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-surface text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-5 w-5" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "truncate text-sm font-semibold text-foreground", children: scenario.sender }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-0.5 text-sm font-medium text-foreground", children: scenario.subject }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 truncate text-xs text-muted-foreground", children: scenario.preview })
            ] })
          ] }) }),
          expanded && /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "whitespace-pre-wrap font-mono text-xs leading-relaxed text-foreground/90", children: scenario.body })
            }
          ),
          !feedback && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                onClick: () => {
            ...
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                  feedback.correct ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "mt-0.5 h-5 w-5 shrink-0 text-neon-green" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "mt-0.5 h-5 w-5 shrink-0 text-neon-red" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs leading-relaxed text-muted-foreground", children: feedback.explanation })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 rounded-lg bg-surface/50 px-4 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-4 w-4 text-neon-yellow" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Analyze each email carefully. Report phishing attempts, open or ignore legitimate emails." })
    ] })
  ] });
}
function PlayPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "min-h-screen bg-background pt-20 pb-8 cyber-grid", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-5xl px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GamePlay, {}) }) })
  ] });
}
export {
